        ...
        public function render(): string
        {
                ...
                <div class="metro-registration-tool__shell">
                    <div class="metro-registration-tool__hero">
                        ...
                        <div class="metro-registration-tool__hero-copy">
                            ...
                            <form class="metro-registration-tool__search metro-registration-tool__search--hero" novalidate>
                                ...
                                <div class="metro-registration-tool__search-row">
                                    <div class="metro-registration-tool__input-wrap">
                                        <textarea
                                        ...
                                        ></textarea>
                                        <button class="metro-registration-tool__button metro-registration-tool__button--inline" type="submit" aria-label="Search">
                                            <span class="metro-registration-tool__button-label">Search</span>
                                            <span class="metro-registration-tool__button-icon" aria-hidden="true">
                                                <svg viewBox="0 0 24 24" focusable="false">
                                                    <path fill="currentColor" d="M10.5 4a6.5 6.5 0 1 1 0 13a6.5 6.5 0 0 1 0-13m0-2a8.5 8.5 0 1 0 5.31 15.14l4.52 4.52l1.41-1.41l-4.52-4.52A8.5 8.5 0 0 0 10.5 2"/>
                                                </svg>
                                            </span>
                                        </button>
                                    </div>
                        ...
                        <div class="metro-registration-tool__hero-support">
                            <div class="metro-registration-tool__hero-note">
                                <span class="metro-registration-tool__hero-stat-label">Single trailer lookup</span>
                                <p>Start typing a trailer number, VIN, or registration number and we&apos;ll suggest matches after the first few characters.</p>
                            </div>
                            <div class="metro-registration-tool__hero-note">
                                <span class="metro-registration-tool__hero-stat-label">Multi trailer lookup</span>
                                <p>Use a comma-separated list of identifiers to review exact matches, missing units, and available documents all at once.</p>
                            </div>
                            <div class="metro-registration-tool__hero-note">
                                <span class="metro-registration-tool__hero-stat-label">Vehicle details</span>
                                <p>See the trailer description, make, year, VIN, and registration number in the same results table as the document actions.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style>
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-grid {
                    background-image: radial-gradient(circle, rgba(9, 34, 64, 0.22) 0 3px, transparent 4px);
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-copy {
                    align-items: center;
                    display: grid;
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__search--hero {
                    margin-top: 1.4rem;
                    max-width: 860px;
                    padding: 0;
                    width: 100%;
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-support {
                    background-image: radial-gradient(circle, rgba(9, 34, 64, 0.2) 0 4px, transparent 5px);
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-note {
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-note p {
                    color: var(--metro-muted);
                    font-size: 0.92rem;
                    font-weight: 600;
                    line-height: 1.5;
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__search--hero .metro-registration-tool__label,
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__search--hero .metro-registration-tool__hint,
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__search--hero .metro-registration-tool__error {
                    text-align: left;
                }
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__input-wrap {
                    height: 56px;
                    position: relative;
                }
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__input {
                    ...
                    min-height: 56px;
                    overflow-y: hidden;
                    padding: 0.6rem 8.25rem 0.6rem 0.9rem;
                    resize: none;
                    width: 100%;
                }

                #<?php echo esc_attr($component_id); ?>.is-batch .metro-registration-tool__input-wrap {
                    height: auto;
                }

                #<?php echo esc_attr($component_id); ?>.is-batch .metro-registration-tool__input {
                    height: 132px;
                    max-height: 260px;
                    min-height: 132px;
                    overflow-y: auto;
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__button--inline {
                    align-items: center;
                    height: 44px;
                    min-height: 0;
                    justify-content: center;
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__button-icon {
                    display: none;
                    line-height: 0;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__button-icon svg {
                    display: block;
                    height: 1.1rem;
                    width: 1.1rem;
                }
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__button--inline:hover {
                    transform: none;
                }
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__button--inline:disabled {
                    transform: none;
                }
                ...
                @media (min-width: 721px) {
                    #<?php echo esc_attr($component_id); ?>.has-results .metro-registration-tool__hero-support {
                        display: none;
                    }
                }
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(1),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(1) {
                    min-width: 84px;
                    width: 84px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(2),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(2) {
                    min-width: 84px;
                    width: 84px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(3),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(3) {
                    min-width: 140px;
                    width: 140px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(4),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(4) {
                    min-width: 280px;
                    width: 280px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(5),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(5) {
                    min-width: 160px;
                    width: 160px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(6),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(6) {
                    min-width: 100px;
                    width: 100px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(7),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(7) {
                    min-width: 290px;
                    width: 290px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single th:nth-child(8),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--single td:nth-child(8) {
                    min-width: 180px;
                    width: 180px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(1),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(1) {
                    min-width: 170px;
                    width: 170px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(2),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(2) {
                    min-width: 84px;
                    width: 84px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(3),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(3) {
                    min-width: 84px;
                    width: 84px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(4),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(4) {
                    min-width: 140px;
                    width: 140px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(5),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(5) {
                    min-width: 280px;
                    width: 280px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(6),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(6) {
                    min-width: 160px;
                    width: 160px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(7),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(7) {
                    min-width: 100px;
                    width: 100px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(8),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(8) {
                    min-width: 290px;
                    width: 290px;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch th:nth-child(9),
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__table--batch td:nth-child(9) {
                    min-width: 180px;
                    width: 180px;
                }
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__doc-button-icon {
                    align-items: center;
                    display: inline-flex;
                    justify-content: center;
                }

                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__doc-button-icon svg {
                    display: block;
                    flex: 0 0 auto;
                    height: 1rem;
                    width: 1rem;
                ...
                @media (max-width: 720px) {
                    ...
                    #<?php echo esc_attr($component_id); ?> .metro-registration-tool__button-label {
                        display: none;
                    }
            ...
            <script>
                (function () {
                    ...
                    function syncResultsState() {
                        root.classList.toggle('has-results', !!results.innerHTML.trim());
                    }
                    ...
                    function getDocumentIconSvg(documentType) {
                        if (documentType === 'Registration') {
                            return '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="currentColor" d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 18.5zm2.5-.5a.5.5 0 0 0-.5.5V8h12V5.5a.5.5 0 0 0-.5-.5zm11.5 5H6v8.5a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 .5-.5zM8 13h3v2H8zm5 0h3v2h-3z"/></svg>';
                        }

                        return '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="currentColor" d="M7 4h10l3 5v9.5A2.5 2.5 0 0 1 17.5 21h-11A2.5 2.5 0 0 1 4 18.5V9zm.8 2L6 9h12l-1.8-3zM8 11v3l2-1.5zm4 0v3l2-1.5zm4 0v3l2-1.5z"/></svg>';
                    }

                    function renderDocButton(trailer, documentType, label) {
                        const folder = trailer && trailer.folder ? trailer.folder : null;
                        if (!folder || !folder.id) {
                            return '<span class="metro-registration-tool__doc-placeholder">N/A</span>';
                        }
                        ...
                        if (available === true || available === null) {
                            ...
                            return `<button class="metro-registration-tool__doc-button${loadingClass}" type="button" aria-label="${escapeHtml(buttonLabel)}" title="${escapeHtml(buttonLabel)}" data-folder-id="${escapeHtml(folder.id)}" data-document-type="${escapeHtml(documentType)}"${disabledAttr}><span class="metro-registration-tool__doc-button-icon">${getDocumentIconSvg(documentType)}</span></button>`;
                        }
                    ...
                    function renderSingleResults(payload) {
                        ...
                        results.innerHTML = `
                            <div class="metro-registration-tool__results-table">
                                <table class="metro-registration-tool__table metro-registration-tool__table--single">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="metro-registration-tool__doc-heading">Regis.</th>
                                            <th scope="col" class="metro-registration-tool__doc-heading">FHWA</th>
                                        ...
                                        ${folders.map(function (trailer) {
                                            return `
                                                <tr data-folder-id="${escapeHtml(trailer.folder && trailer.folder.id ? trailer.folder.id : '')}">
                                                    <td class="metro-registration-tool__doc-cell">${renderDocButton(trailer, 'Registration', 'Regis.')}</td>
                                                    <td class="metro-registration-tool__doc-cell">${renderDocButton(trailer, 'FHWA Inspection', 'FHWA')}</td>
                    ...
                    function renderBatchResults(payload) {
                        ...
                        if (rows.length > 0) {
                            html += `
                                <div class="metro-registration-tool__results-table">
                                    <table class="metro-registration-tool__table metro-registration-tool__table--batch">
                                        <thead>
                                            <tr>
                    ...
                    async function performSearch(query, silent) {
                        ...
                        if (
                            state.lastSubmittedQuery === trimmed &&
                            state.lastRenderMode === 'single' &&
                            state.lastPayload &&
                            String(state.lastPayload.query || '').trim() === trimmed
                        ) {
                            return;
                        }

                        state.lastSubmittedQuery = trimmed;
                        await performSingleSearch(trimmed, false);
                    }
                    ...
                    input.addEventListener('input', function () {
                        ...
                        state.activeQuery = trimmed;
                        setBatchMode(isBatchQuery(trimmed));
