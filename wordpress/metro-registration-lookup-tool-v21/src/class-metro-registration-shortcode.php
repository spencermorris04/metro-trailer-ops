                ...
                <div class="metro-registration-tool__shell">
                    <div class="metro-registration-tool__hero">
                        <div class="metro-registration-tool__hero-copy">
                            ...
                            <p class="metro-registration-tool__lede">
                                Search trailer records by trailer number, service item, VIN, or registration number.
                            </p>
                        ...
                        <div class="metro-registration-tool__hero-card">
                            ...
                            <div class="metro-registration-tool__hero-stat">
                                ...
                                <strong>Start typing a trailer number, service item, VIN, or registration number and we&apos;ll suggest matches after the first few characters.</strong>
                            </div>
                            <div class="metro-registration-tool__hero-stat">
                            ...
                            <div class="metro-registration-tool__hero-stat">
                                ...
                                <strong>See the trailer description, make, year, VIN, registration number, and service item in the same results table as the document actions.</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="metro-registration-tool__search" novalidate>
                        <label class="metro-registration-tool__label" for="<?php echo esc_attr($component_id); ?>-query">
                            Search trailer number, service item, VIN, or registration number
                        </label>
                                        ...
                                        ${folders.map(function (trailer) {
                                            return `
                                                <tr data-folder-id="${escapeHtml(trailer.folder && trailer.folder.id ? trailer.folder.id : '')}">
                                                    ...
                                                    <td><p class="metro-registration-tool__result-name">${escapeHtml(trailer.service_item_number || '')}</p></td>
                                                    ...
                                                    <td class="metro-registration-tool__doc-cell">${renderDocButton(trailer, 'FHWA Inspection', 'Open FHWA')}</td>
                                                </tr>
                                            `;
                                        }).join('')}
                                    </tbody>
