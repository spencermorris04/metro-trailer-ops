                    ...
                    <div class="metro-registration-tool__hero">
                        ...
                        <div class="metro-registration-tool__hero-card">
                            ...
                            <div class="metro-registration-tool__hero-stat">
                                ...
                                <strong>Paste a list of trailer numbers to review matches, missing units, and available documents all at once.</strong>
                            </div>
                            <div class="metro-registration-tool__hero-stat">
                                <span class="metro-registration-tool__hero-stat-label">Bulk download</span>
                                <strong>When you're ready, download every available registration and inspection file together in one organized ZIP.</strong>
                            </div>
                        </div>
                    </div>
