        ...
        public function render(): string
        {
            ...
            <style>
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-grid {
                    background-image: radial-gradient(circle, rgba(13, 47, 99, 0.14) 0 3px, transparent 4px);
                ...
                #<?php echo esc_attr($component_id); ?> .metro-registration-tool__hero-note::before {
                    background-image: radial-gradient(circle, rgba(13, 47, 99, 0.12) 0 2px, transparent 3px);
