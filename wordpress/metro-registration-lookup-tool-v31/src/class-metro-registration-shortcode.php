                ...
                (function () {
                    ...
                    function renderDocButton(trailer, documentType, label) {
                        ...
                        if (available === true || available === null) {
                            ...
                            return `<button class="metro-registration-tool__doc-button${loadingClass}" type="button" data-folder-id="${escapeHtml(folder.id)}" data-document-type="${escapeHtml(documentType)}"${disabledAttr}><span class="metro-registration-tool__doc-button-icon">${getDocumentIconSvg(documentType)}<span>${escapeHtml(buttonLabel)}</span></span></button>`;
                        }
