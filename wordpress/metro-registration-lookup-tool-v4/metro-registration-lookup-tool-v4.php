<?php
/**
 * Plugin Name: Metro Registration Lookup Tool V4
 * Description: Provides a trailer registration and FHWA inspection lookup form and REST endpoint backed by Microsoft Graph and SharePoint.
 * Version: 0.4.1
...
define('METRO_REGISTRATION_LOOKUP_VERSION', '0.4.1');
