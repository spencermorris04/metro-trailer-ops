...
if (!class_exists('Metro_Registration_Settings')) {
    class Metro_Registration_Settings
    {
        ...
        public function register_settings(): void
        {
            ...
            add_settings_section(
                ...
                static function (): void {
                    echo '<p>Enter the Microsoft Graph app and SharePoint settings used by the registration lookup endpoint.</p>';
                },
                'metro-registration-lookup-tool'
            );
        ...
        public function sanitize_settings($input): array
        {
            ...
            foreach (array_keys(self::FIELD_LABELS) as $field_name) {
        ...
        public function render_settings_page(): void
        {
            ...
            ?>
            <div class="wrap">
                <h1>Metro Registration Lookup Tool</h1>
                ...
                <script>
                    (function () {
                        const button = document.getElementById('metro-registration-start-refresh');
                        const progress = document.getElementById('metro-registration-refresh-progress');
                        const statusEl = document.getElementById('metro-registration-index-status');
                        const countEl = document.getElementById('metro-registration-index-count');
                        const completedEl = document.getElementById('metro-registration-index-completed');
                        const errorEl = document.getElementById('metro-registration-index-error');
                        ...
                        async function runRefresh(reset) {
                            const data = await post('metro_registration_refresh_index', { reset: reset ? '1' : '0' });
                            applyStatus(data);
                        ...
                        button.addEventListener('click', function () {
                            ...
                            progress.textContent = 'Starting trailer index rebuild...';
