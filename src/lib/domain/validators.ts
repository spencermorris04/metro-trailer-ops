...
export const customerUpdateSchema = z.object({
  ...
  responsibilityCenter: z.string().max(80).optional(),
  defaultSalesTeam: z.string().max(80).optional(),
  defaultDealCode: z.string().max(80).optional(),
  damageWaiverDeclined: z.boolean().optional(),
  insuranceCertRequired: z.boolean().optional(),
  insuranceExpirationDate: z.coerce.date().nullable().optional(),
  insurancePolicyNo: z.string().max(160).optional(),
  registrationNumber: z.string().max(120).optional(),
});
...
export const contractLineSchema = z
  .object({
    ...
    lineKind: z.enum(contractLineKinds).optional(),
    sourceLineType: z.string().max(80).optional(),
    sourceSequenceNo: z.number().int().optional(),
    sourceDealCode: z.string().max(80).optional(),
    sourceDealLength: z.number().optional(),
    billingFor: z.string().max(120).optional(),
    invoiceFromDate: z.coerce.date().nullable().optional(),
    invoiceThruDate: z.coerce.date().nullable().optional(),
    shipmentDate: z.coerce.date().nullable().optional(),
    returnDate: z.coerce.date().nullable().optional(),
    taxGroupCode: z.string().max(80).optional(),
    damageWaiverPercent: z.number().optional(),
    parentItemLineNo: z.number().int().optional(),
    legacyPostingDate: z.coerce.date().nullable().optional(),
...
export const contractSchema = z
  .object({
    ...
    branchId: z.string().min(1),
    agreementKind: z.enum(agreementKinds).default("rental_order"),
    legacySourceSystem: z.string().max(80).optional(),
    legacyDocumentNo: z.string().max(120).optional(),
    legacyPreviousDocumentNo: z.string().max(120).optional(),
    legacyPreviousDocumentType: z.string().max(80).optional(),
    serviceBranchId: z.string().min(1).optional(),
    serviceLocationCode: z.string().max(80).optional(),
    agreementState: z.string().max(80).optional(),
    importCompleteness: z.enum(importCompletenesses).optional(),
    legacyOpenedAt: z.coerce.date().nullable().optional(),
    legacyClosedAt: z.coerce.date().nullable().optional(),
...
export const financialEventSchema = z.object({
  ...
  assetId: z.string().optional(),
  contractLineId: z.string().optional(),
  ...
  legacyOrderNo: z.string().max(120).optional(),
  legacyInvoiceNo: z.string().max(120).optional(),
  legacyLineNo: z.number().int().optional(),
  revenueRecognitionBasis: z.enum(revenueRecognitionBases).optional(),
  sourceDocumentType: z.string().max(80).optional(),
  sourceDocumentNo: z.string().max(120).optional(),
  sourceSnapshot: z.record(z.string(), z.unknown()).optional(),
});
...
export const invoiceSchema = z.object({
  ...
  legacyInvoiceNo: z.string().max(120).optional(),
  legacyOrderNo: z.string().max(120).optional(),
  invoiceSourceKind: z.enum(invoiceSourceKinds).default("app_native"),
  importCompleteness: z.enum(importCompletenesses).optional(),
  postingDate: z.coerce.date().nullable().optional(),
  responsibilityCenter: z.string().max(80).optional(),
  dimensionSetId: z.number().int().optional(),
  sourceProvider: z.enum(integrationProviders).optional(),
  sourceDocumentType: z.string().max(80).optional(),
  sourceDocumentNo: z.string().max(120).optional(),
  sourceStatus: z.string().max(80).optional(),
